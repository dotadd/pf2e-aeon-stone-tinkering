...
export async function createJournal(latticeItems, moldItems, impurityItems) {
...
function formatComponentsPage(components) {
    let pageText = "";
...
function formatComponentForJournal(component) {
    if (!component._id) {
