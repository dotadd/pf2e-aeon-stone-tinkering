...
export const l1LesserInnateEffect = [
    ...
    Ability.lesserInnateEffect("Sprout Tail", "<span class=\"action-glyph\">1</span> (Concentrate) You gain a tail unarmed attack for 1 minute. It deals 1d6 bludgeoning damage. It is in the brawling group and has the sweep trait. @UUID[Compendium.pf2e-aeon-stone-tinkering.pf2e-aeon-stone-tinkering-items.Item.8xm5718CMMefW85g]{Effect: Sprout Tail}", []),
]
...
export const l3MartialTalent = [
    ...
    Ability.martialTalent("@UUID[Compendium.pf2e.feats-srd.Item.9CaaU5szcf3mtJXD]{Overextending Feint}"), //
    Ability.martialTalent("@UUID[Compendium.pf2e.feats-srd.Item.Wx12NUjqTOjFrEoW]{Antagonize}"), //   
]
...
export const l3AlchemicalInfusion = [
    ...
    Ability.alchemicalInfusion("@UUID[Compendium.pf2e.equipment-srd.Item.8g2U2PMC0lkPZEvq]{Blood Booster (Lesser)}") //
]
...
export const l3MagicTrick = [
    ...
    Ability.magicTrick("Dousing Spell", "Once per hour, you can use the @UUID[Compendium.pf2e.feats-srd.Item.nroOy0PBeEUGdUXD]{Dousing Spell} spellshape. Instead of applying it to a spell, you may apply it to any spell-like activity that takes at least two actions and has the Water trait.", []), //
    ...
    Ability.magicTrick("Shifting Spell", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per day, if your next action is to Cast a Spell or use a spell-like action with the air, water or teleportation traits, after resolving the spell, you Step.", []), //
    ...
    Ability.magicTrick("Grandiose Spell", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per day, if your next action is to Cast a Spell or use a spell-like action with the visual trait, after the spell resolves, choose a creature within 60 feet that can see you. It must make a @Check[type:will|against:class-spell|rollerRole:target]{will} saving throw against your class or spell DC. Unless it critically succeeds, it is @UUID[Compendium.pf2e.conditionitems.Item.AdPVz7rbaVSRxHFg]{Fascinated} by you for up to 1 round. On a failure, it is also @UUID[Compendium.pf2e.conditionitems.Item.e1XGnhKNSQIm5IXg]{Stupefied 1} for 1 round.", []), //
    Ability.magicTrick("Pacifying Spell", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per day, if your next action is to Cast a Spell or use a spell-like action with the nonlethal trait, a creature that is hit by the spell or fails a save against it is @UUID[Compendium.pf2e.conditionitems.Item.dfCMdR4wnpbYNTix]{Stunned 1}.", []),
    Ability.magicTrick("Omen Spell", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per day, if your next action is to Cast a Spell or use a spell-like action that targets exactly one ally, choose an enemy within 30 feet. It is @UUID[Compendium.pf2e.conditionitems.Item.AJh5ex99aV6VTggg]{Off-Guard} against that allies next attack for up to one round. If that ally hits that enemy with an attack within that round, the enemy becomes @UUID[Compendium.pf2e.conditionitems.Item.TBSHQspnbcqxsmjL]{Frightened 1}.", []),
    Ability.magicTrick("Pattern Spell: Square", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per hour, if your next action is to Cast a Spell or use a spell-like action that targets a burst, pick four spaces within the burst whose centers form the corners of a square. Instead of the burst, the spell affects all creatures in spaces intersected by edges of the square.,", []),
    Ability.magicTrick("Pattern Spell: Triangle", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per hour, if your next action is to Cast a Spell or use a spell-like action that targets a cone, instead pick a space adjacent to you. Then pick two additional spaces so that the distances between the centers of all three spaces are equal to the length of the cone. The spell affects all creatures in spaces intersected by the edges of the triangle whose corners are the centers of the chosen spaces.,", []),
    Ability.magicTrick("Pattern Spell: Hexagon", "<span class=\"action-glyph\">f</span> (Concentrate, Spellshape) Once per hour, if your next action is to Cast a Spell or use a spell-like action that targets an emanation, instead pick six spaces within the emanation so that the centers of each space are equally far from those of exactly the closest two and so that they are all in one plane. The spell affects all creatures in spaces intersected by the edges of the hexagon whose corners are the centers of the chosen spaces.,", []),
]
...
export const l5InnateEffect = [
    ...
    //@ts-ignore
    Ability.innateEffect("Steel Nails", "<span class=\"action-glyph\">1</span> (Concentrate) You gain a claw unarmed attack for 1 minute. It deals 1d4 slashing damage and an additional 1d6 cold damage. It is in the brawling group, made of cold iron and has the versatile p, agile and finesse traits. @UUID[Compendium.pf2e-aeon-stone-tinkering.pf2e-aeon-stone-tinkering-items.Item.erH86zuyGOhgPslq]{Effect: Cold Iron Nails}", []), //
    Ability.innateEffect("Vampiric Fangs", "<span class=\"action-glyph\">1</span> (Concentrate) You gain a jaws unarmed attack for 1 minute. It deals 1d6 piercing damage and an additional 1d6 persistent bleed damage. It is in the brawling group and has the finesse trait. @UUID[Compendium.pf2e-aeon-stone-tinkering.pf2e-aeon-stone-tinkering-items.Item.Swff2MhZIxHPzYAB]{Effect: Vampiric Fangs}", []), //
    ...
    Ability.innateEffect("Lexical Knowledge: Warfare", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Warfare Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
    Ability.innateEffect("Lexical Knowledge: Sailing", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Sailing Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
    Ability.innateEffect("Lexical Knowledge: Cooking", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Cooking Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
    Ability.innateEffect("Lexical Knowledge: Farming", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Farming Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
    Ability.innateEffect("Lexical Knowledge: Mercantile", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Mercantile Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
    Ability.innateEffect("Lexical Knowledge: Legal", "You gain the @UUID[Compendium.pf2e.feats-srd.Item.BocFD2KV0qgUC76x]{Additional Lore} feat for Legal Lore. This temporary lore cannot be used as a prerequisite for any permanent feats or abilities.", []), //
]
...
export const l7Spell = [
    ...
    Ability.spell("@UUID[Compendium.pf2e.spells-srd.Item.FwW2asotQE8dH1WP]{Whispers of the Void}", "divine"), //
    Ability.spell("@UUID[Compendium.pf2e.spells-srd.Item.ikSb3LRGnrwXJBVX]{Vital Beacon}", "divine"), //
    Ability.spell("@UUID[Compendium.pf2e.spells-srd.Item.V8wXOsoejQhe6CyG]{Vapor Form}", "occult"), //
    Ability.spell("@UUID[Compendium.pf2e.spells-srd.Item.HqTI6wRrck1YXp3F]{Telepathy}", "occult"), //
