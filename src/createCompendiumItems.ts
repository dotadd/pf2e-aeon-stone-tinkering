...
export async function createComponentType(compendium: string, folder: string, components: Array<Lattice|Mold|Impurity>): Promise<Array<Item>> {
    let items = [];
...
export async function createComponents(compendium: string = "pf2e-aeon-stone-tinkering.pf2e-aeon-stone-tinkering-items"): Promise<{latticeItems: Array<Item>, moldItems: Array<Item>, impurityItems: Array<Item>}> {
