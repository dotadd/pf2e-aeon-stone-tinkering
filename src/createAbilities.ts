...
export const l7Replenishment = [
    ...
    Ability.replenishment("Emergency Stash", "Once per day, as a free action you can replenish all of your @UUID[Compendium.pf2e.classfeatures.Item.PBQh0amk1FlomV0r]{Versatile Vials}. If you did not receive them from a feature of your class, you instead restore half the amount.", []),
...
export const l7Rush = [
    Ability.rush("Swift Assault", "<span class=\"action-glyph\">1</span> Once per day, you Step or Stride, followed by a Strike.", []),
    Ability.rush("Call and Echo", "<span class=\"action-glyph\">3</span> Once per day, you cast a spell that takes <span class=\"action-glyph\">2</span> or less, followed by a cantrip that takes <span class=\"action-glyph\">2</span> or less.", []),
    Ability.rush("Tavern Experience", "<span class=\"action-glyph\">2</span> Once per day, you draw an ingested consumeable you are wearing, use it, then Stride or @UUID[Compendium.pf2e.actionspf2e.Item.21WIfSu7Xd7uKqV8]{Tumble Through} and finally @UUID[Compendium.pf2e.actionspf2e.Item.2u915NdUyQan6uKF]{Demoralize} an enemy.", []),
    Ability.rush("", "", []),
    Ability.rush("", "", []),
]
...
export const l7InnateEffect = [
    ...
    Ability.innateEffect("Force Limb", "You gain an additional limb made of pure force. It can pick up, hold and put down objects, but not use or wield them. It can only operate simple mechanisms, like door handles.", []),
